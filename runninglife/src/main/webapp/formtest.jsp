...
<link rel="stylesheet" href="/runninglife/resources/css/reset.css">


<link rel="stylesheet" href="/runninglife/resources/css/style.css">
...
<body>
	...
	<!-- multistep form -->
	<form:form id="msform" modelAttribute="">
		<!-- progressbar -->
		<ul id="progressbar">
		...
		<fieldset>
			...
			<form:input type="text" name="email" path="email" /> <form:input
				type="password" name="pass" path="password" /> <form:input
				type="password" name="cpass" path="confirmPassword" /> <input
	...
	<script src="/runninglife/resources/js/form.js"></script>
