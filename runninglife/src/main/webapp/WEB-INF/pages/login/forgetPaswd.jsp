  ...
  <div class="row">
	<form action="CheckAccount.do" method="post">
		<table>
			...
			<tbody>
				<tr>
					<td><input type="text" class="alert alert-dismissible cols-sm-5 input-group" name="memberAccount" 
							id="fAccount" value="${param.memberAccount}" placeholder="請輸入帳號"/>
					</td>
				</tr>
				<tr>
					<td><input type="text" class="alert alert-dismissible cols-sm-5 input-group" name="memberEmail" 
							id="fEmail" value="${param.memberEmail}" placeholder="請輸入Email" />
					</td>
				</tr>
				<tr>
