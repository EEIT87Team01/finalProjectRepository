...
<table>
		...
		<tbody>
			...
			<tr><td>電話:<input type="text" name="phone" class="form-control"></td></tr>
...
// 	$.getJSON('/runninglife/Login/Location.do',function(datas){
// 		var items = [];
...
// 				message = $.parseJSON(response.jsondata);
// // 				var locationName = $(this).children("CategoryID").text();
// 				console.log(message.locationName);
// 				result = message;
// // 				var opt = $("<option></option>").text(locations).val(locationName);
// // 				$('#select').append(opt);
