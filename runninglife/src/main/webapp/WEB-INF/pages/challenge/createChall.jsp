		...
		<div class="container">
			<div class="row">
				...
				<table class="table">
					<tr>
						<td>挑戰名稱：</td>
						<td><input type="text" class="challenName"></td>
					</tr>               
					<tr>
						<td>挑戰距離：</td>
						<td><input type="text" class="challenDistance"></td>
					</tr>         
					<tr>
						<td>挑戰區域：</td>
						<td><input type="text" class="locationID"></td>
					</tr>                 
					<tr>
						<td>起始時間：</td>
						<td><input type="text" class="challenStartTime"></td>
					</tr>                
					<tr>
						<td>結束時間：</td>
						<td><input type="text" class="challenEndTime"></td>
					</tr>                
					<tr>
						<td>挑戰目的：</td>
					...
					<tr>
						<td>邀請好友：</td>
						<td><button class="challinvite">選擇好友</button></td>
					</tr>
					<tr>
						<td></td>
						<td>
							<span class='hidden'><img /><span class='join'></span><button class="btn btn-danger">取消</button></span>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<p align="right">
								<button class="btn btn-success create">創設挑戰</button>
