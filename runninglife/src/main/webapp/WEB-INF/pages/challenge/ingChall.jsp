...
<div id="fh5co-page">
		...
		<div class="container">
			...
			<c:forEach var="challenData" items="${challenDataList}">
			<c:set var="challenge" value="${challenData.challDataPK.challenID}"/>
			<div class="list">
			    <div class="challColumn">	    
						<h2><span class="challenName">${challenge.challenName}</span><span class="day"  style="float:right;"></span><span class="day" style="float:right;">${r:day(challenge.challenEndTime)} 天後結束</span></h2>
						<hr style="border:1px solid blue;">
						<h4><span class="founderID">${challenge.founderID.firstName}, ${challenge.founderID.lastName}</span></h4>
						<h4><span class="comment">${challenge.comment}</span></h4>
						<h4><span class="challenStartTime">${challenge.challenStartTime}</span> - <span class="challenEndTime">${challenge.challenEndTime}</span></h4>
						<h4><span class="challenDistance">${challenge.challenDistance}</span>公里 <p align="right"><a href="ingChallDetail/${challenge.challenID}.do" class="btn btn-info">挑戰進度</a></p></h4>
				</div>
			</div>
			</c:forEach>
