...
<div id="fh5co-page">
	...
	<div class="container">
			...
			<div class="row">
					...
					<a href="createChallPage.do" class="item-grid text-center">
						...
						<div class="v-align">
							<div class="v-align-middle">
								<h3 class="title">創設新挑戰</h3>
								<h5 class="category">建立一個新挑戰</h5>
							</div>
						</div>
					</a>
				</div>
				...
				<div class="col-md-4 animate-box">
					<a href="finishChall.do" class="item-grid text-center">
						<div class="image" style="background-image: url(../images/finchall.jpg)"></div>
						<div class="v-align">
							<div class="v-align-middle">
								<h3 class="title">已結束的挑戰</h3>
								<h5 class="category">查看挑戰結果</h5>
							</div>
						</div>
					</a>
				</div>
				<div class="col-md-4 animate-box">
					<a href="designChall.jsp" class="item-grid text-center">
						<div class="image" style="background-image: url(../images/reserchall.jpg)"></div>
						<div class="v-align">
							<div class="v-align-middle">
								<h3 class="title">預定的挑戰</h3>
								<h5 class="category">查看將要開始的挑戰</h5>
							</div>
						</div>
					</a>
				</div>
				<div class="col-md-4 animate-box">
					<a href="friendChall.jsp" class="item-grid text-center">
						<div class="image" style="background-image: url(../images/friendchall.jpg)"></div>
						<div class="v-align">
							<div class="v-align-middle">
								<h3 class="title">好友的挑戰</h3>
								<h5 class="category">觀看朋友的挑戰</h5>
							</div>
						</div>
					</a>
				</div>
				<div class="col-md-4 animate-box">
					<a href="inviteChall.jsp" class="item-grid text-center">
						<div class="image" style="background-image: url(../images/invitechall.jpg)"></div>
						<div class="v-align">
							<div class="v-align-middle">
								<h3 class="title">邀請的挑戰</h3>
								<h5 class="category">來自好友的邀請</h5>
							</div>
						</div>
					</a>
				</div>
