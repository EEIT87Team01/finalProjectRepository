...
<!--             </nav> -->
	...
	<div class='container'>
	<h1 style="color:white;">我的文章列表</h1>
		<div class='row'>
			<p align="right">
				<a href='articleEditor.html' class='btn btn-info'>新增文章</a>
			</p>
			<table class='table'>
				<thead>
					<tr>
				...
				<tbody class='list'>
					<tr class='adColumn hidden'>
						<td class="col-md-6"><span class='title'></span></td>
						<td class="col-md-2"><span class='createTime'></span></td>
						<td class="col-md-2"><span class='writerAccount'></span></td>
						<td class="col-md-2"><button class='btn btn-primary modify'>修改</button>
