...
<title>Respmail is a response HTML email designed to work on all
	major email platforms and smartphones</title>
<style type="text/css">
/* RESET STYLES */
html {
...
@media only screen and (max-width: 480px) {
	...
	table[id="emailHeader"], table[id="emailBody"], table[id="emailFooter"],
		table[class="flexibleContainer"], td[class="flexibleContainerCell"] {
		width: 100% !important;
	}
...
<body bgcolor="#E1E1E1" leftmargin="0" marginwidth="0" topmargin="0"
																		...
																		<td valign="top" class="textContent">
																			...
																			<div mc:edit="body"
																				...
																				<ul>
																					<li>銀行代碼：004</li>
																					<li>戶名：林淑娟</li>
																					<li>帳號：089004214583</li>
																					<li>匯款銀行：臺灣銀行蘇澳分行</li>
																				<!--	<li>應繳費金額:${runner.event.fee}</li> -->
																					<li>runner test:${runner.eventID}</li>
																				<!--	<li>繳費代碼:cx1309111754040</li>  -->
																			<!--	<li>繳費期限:2016-10-16 23:59:00</li>  -->
																			<!--	<li>商品名稱:${contest.contestName}</li> -->
																				<!--	<li>收費商家:RunningLife</li>-->
																					匯款完成後，請來電 0963-776895 告知帳號末五碼，以便為您查詢匯款是否入帳成功。
																				</ul>
																		</td>
																	</tr>
																</table> <!-- // CONTENT TABLE -->
															...
															<td align="center" valign="top">
																...
																<table border="0" cellpadding="0" cellspacing="0"
																	...
																	<tr>
																		<td valign="top" class="textContent">
																			<div
																				style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 15px; margin-bottom: 0; margin-top: 3px; color: #5F5F5F; line-height: 135%;">感謝您的報名，請於報名內14天完成繳費請於報名內14天完成繳費</div>
																		</td>
																	</tr>
																</table> <!-- // CONTENT TABLE -->
																...
																<div
																	...
																	<div>
																		Copyright &#169; 2014 <a
																			...
																			style="color: #828282;">RunningLife</span></a>.
																		All&nbsp;rights&nbsp;reserved.
																	</div>
																</div>
